...
import { FlameGraphData } from "../types";
import { PhysicalViewData, DebugSession } from "../types";
...
const Visualization = forwardRef<
  VisualizationHandle,
  VisualizationProps
>(
  (
    ...
    const exportSvg = () => {
      ...
      a.href = url;
      a.download = `visualization-${viewType}-${new Date()
        .toISOString()
        .slice(0, 10)}.svg`;
