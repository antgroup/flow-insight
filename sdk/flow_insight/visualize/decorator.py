...
def create_instrumented_method(original_method, service_name: str, method_name: str):
    ...
    def _flow_insight_instrumented_method(*args, **kwargs):
        ...
        target_instance_id = _get_target_instance_id(args)
        _emit_bidirectional_object_events(args, kwargs, flow_id, method_name, timestamp, 
                                         source_service, source_instance_id, source_method, service_name, target_instance_id)
...
def _emit_bidirectional_object_events(args, kwargs, flow_id: str, method_name: str, timestamp: int, source_service: str, source_instance_id: str, source_method: str, target_service: str, target_instance_id: str):
